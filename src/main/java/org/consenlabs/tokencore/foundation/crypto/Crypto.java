...
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.EXISTING_PROPERTY, property = "kdf")
@JsonSubTypes({ @JsonSubTypes.Type(value = SCryptCrypto.class, name = "scrypt"), @JsonSubTypes.Type(value = PBKDF2Crypto.class, name = "pbkdf2") })
public class Crypto<T extends KDFParams> {
	...
	public void validate() {
		if ((!CTR.equals(cipher) && !CBC.equals(cipher)) || cipherparams == null || Strings.isNullOrEmpty(mac) || Strings.isNullOrEmpty(ciphertext) || kdfparams == null) {
	...
	public boolean equals(Object o) {
		...
		if (this.kdfparams != null ? !this.kdfparams.equals(that.kdfparams) : that.kdfparams != null) {
			return false;
		}
